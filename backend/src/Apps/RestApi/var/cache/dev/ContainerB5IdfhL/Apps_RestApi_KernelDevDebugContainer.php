 ...
 */
class Apps_RestApi_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Apps\\RestApi\\Modules\\Account\\Controllers\\BaseController' => 'getBaseControllerService',
            'Apps\\RestApi\\Modules\\Common\\Controllers\\ErrorController' => 'getErrorControllerService',
            'Apps\\RestApi\\Modules\\ConfirmationCode\\Controllers\\BaseController' => 'getBaseController2Service',
            'Apps\\RestApi\\Modules\\Sensor\\Controllers\\BaseController' => 'getBaseController3Service',
            'Apps\\RestApi\\Modules\\Session\\Controllers\\BaseController' => 'getBaseController4Service',
            'Apps\\RestApi\\Modules\\User\\Controllers\\BaseController' => 'getBaseController5Service',
    ...
    {
        return $this->privates['exception_listener'] = new \Symfony\Component\HttpKernel\EventListener\ErrorListener('Apps\\RestApi\\Modules\\Common\\Controllers\\ErrorController::show', ($this->privates['logger'] ?? $this->getLogger2Service()), true, []);
    }
     ...
     */
    protected function getLogger2Service()
    {
    ...
    {
        return $this->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($this->services['router'] ?? $this->getRouterService()), ($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), ($this->privates['logger'] ?? $this->getLogger2Service()), \dirname(__DIR__, 4), true);
    }
    ...
    protected function getSessionListenerService()
    {
        return $this->privates['session_listener'] = new \Symfony\Component\HttpKernel\EventListener\SessionListener(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'logger' => ['privates', 'logger', 'getLogger2Service', false],
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'debug.container.dump' => ($this->targetDir.''.'/Apps_RestApi_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Apps_RestApi_KernelDevDebugContainer',
            ...
            'kernel.error_controller' => 'Apps\\RestApi\\Modules\\Common\\Controllers\\ErrorController::show',
