...
class Apps_RestApi_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['exception_listener'] = new \Symfony\Component\HttpKernel\EventListener\ErrorListener('Apps\\RestApi\\Modules\\Common\\Controllers\\ErrorController::show', ($this->privates['logger'] ?? $this->getLoggerService()), true, []);
    }
